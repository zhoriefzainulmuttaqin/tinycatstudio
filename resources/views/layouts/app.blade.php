...
<html lang="id">
    <head>
        ...
        <!-- Primary Meta Tags -->
        <meta name="title" content="@yield('title', ($siteSettings['site_name'] ?? 'TinyCatStudio') . ' | Software House Premium')">
        <meta name="description" content="@yield('meta_description', $siteSettings['site_tagline'] ?? 'TinyCatStudio adalah software house premium untuk website, aplikasi mobile, logo design, graphic design, dan jasa iklan digital.')">
        <meta name="keywords" content="@yield('meta_keywords', 'software house, jasa pembuatan website, bikin aplikasi mobile, logo design, desain grafis premium, digital marketing, seo indonesia')">
        <meta name="author" content="{{ $siteSettings['site_name'] ?? 'TinyCatStudio' }}">
        <meta name="robots" content="index, follow">

        <!-- Open Graph / Facebook -->
        <meta property="og:type" content="@yield('og_type', 'website')">
        <meta property="og:url" content="{{ request()->url() }}">
        <meta property="og:title" content="@yield('title', ($siteSettings['site_name'] ?? 'TinyCatStudio') . ' | Software House Premium')">
        <meta property="og:description" content="@yield('meta_description', $siteSettings['site_tagline'] ?? 'TinyCatStudio adalah software house premium untuk website, aplikasi mobile, logo design, graphic design, dan jasa iklan digital.')">
        <meta property="og:image" content="@yield('og_image', !empty($siteSettings['site_logo']) ? asset('storage/' . $siteSettings['site_logo']) : asset('logo.png'))">

        <!-- Twitter -->
        <meta property="twitter:card" content="summary_large_image">
        <meta property="twitter:url" content="{{ request()->url() }}">
        <meta property="twitter:title" content="@yield('title', ($siteSettings['site_name'] ?? 'TinyCatStudio') . ' | Software House Premium')">
        <meta property="twitter:description" content="@yield('meta_description', $siteSettings['site_tagline'] ?? 'TinyCatStudio adalah software house premium untuk website, aplikasi mobile, logo design, graphic design, dan jasa iklan digital.')">
        <meta property="twitter:image" content="@yield('og_image', !empty($siteSettings['site_logo']) ? asset('storage/' . $siteSettings['site_logo']) : asset('logo.png'))">
        ...
        <script type="application/ld+json">
        {
          ...
          "@@type": "Organization",
          "name": "{{ $siteSettings['site_name'] ?? 'TinyCatStudio' }}",
          "url": "{{ url('/') }}",
          "logo": "{{ !empty($siteSettings['site_logo']) ? asset('storage/' . $siteSettings['site_logo']) : asset('logo.png') }}",
          "contactPoint": {
            "@@type": "ContactPoint",
            "telephone": "{{ $siteSettings['whatsapp_number'] ?? '+62 812-3456-7890' }}",
          ...
          "sameAs": [
              ...
              @endphp
              {!! implode(',', array_map(fn($url) => '"' . $url . '"', $socials)) !!}
          ]
        }
        </script>
